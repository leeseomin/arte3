...
cd ..
cd s13
parallel convert {}  -set filename:new  ../s25/"%tm5d" "%[filename:new].png" ::: *.*
cd ..
cd s12
parallel gmic {} -fx_pixelsort 1,3,0,1,0,100,0,0,0 -o ../s14/{} ::: *.*
cd ..
cd s14
parallel convert {}  -set filename:new  ../s25/"%tm5a" "%[filename:new].png" ::: *.*
cd ..
cd s8
parallel gmic {} -fx_pixelsort 1,3,2,1,0,100,0,0,0 -o ../s12/{} ::: *.*
cd ..
cd s12
parallel convert {}  -set filename:new  ../s25/"%tm5h" "%[filename:new].png" ::: *.*
